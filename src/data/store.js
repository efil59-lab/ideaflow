...
function demoData() {
  ...
  return {
    ...
    ideas: [
      ...
      { ...base, id: "n9", text: "[ ] לתקן את הברז ⟦p:p2⟧\n[ ] לקנות נורות\n[x] לצבוע את הגדר ⟦p:p2⟧", title: "סידורים לבית", status: "note", colorIdx: 2, createdAt: now - 400e3 },
      { ...base, id: "n1", text: "- חלב\n- לחם\n[x] ביצים", title: "רשימת סופר", status: "note", noCheck: true, colorIdx: 0, tagProject: "p2", createdAt: now - 500e3 },
