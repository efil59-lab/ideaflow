...
function Guide({ onClose, th }) {
  ...
  const features = [
    ...
    { icon: "bell", title: "תזכורות", text: "פעמון על כל כרטיס: בעוד שעה / הערב / מחר או זמן מדויק — כולל חזרה קבועה (כל שעה, יום, שבוע, חודש או שנה). ההתראה מגיעה גם כשהאפליקציה סגורה; לחיצה פותחת את הרעיון, וכפתורי \"15 דק׳\"/\"שעה\" דוחים ברקע — או \"עוד…\" לזמן דחייה מותאם." },
