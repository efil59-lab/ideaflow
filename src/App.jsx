...
const EXPECTED_SW_VERSION = "5.12-1btn";
...
function Guide({ onClose, onLog, th }) {
  ...
  const features = [
    ...
    { icon: "bell", title: "תזכורות", text: "פעמון על כל כרטיס: בעוד שעה / הערב / מחר או זמן מדויק — כולל חזרה קבועה (כל שעה, יום, שבוע, חודש או שנה). ההתראה מגיעה גם כשהאפליקציה סגורה; לחיצה על גוף ההתראה פותחת את הרעיון, וכפתור \"דחה 15 דק׳\" דוחה את התזכורת ברקע בלי לפתוח את האפליקציה." },
