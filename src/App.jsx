...
function Guide({ onClose, th }) {
  ...
  const features = [
    ...
    { icon: "clip", title: "צירוף קבצים ומדיה", text: "לכל רעיון אפשר לצרף תמונות, הקלטות וקבצים (PDF, מסמכים, גיליונות ועוד) — דרך כפתור המהדק בתיבת התפיסה או מקש \"קובץ\" בעורך. אפשר גם להדביק צילום מסך או תמונה ישר עם Ctrl+V (או כפתור \"הדבק\" בעורך). הקובץ מופיע על הכרטיס ונפתח או יורד בלחיצה. עד 10MB לקובץ." },
