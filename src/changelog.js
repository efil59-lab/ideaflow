...
export const CHANGELOG = [
  { icon: "clip", title: "צירוף קבצים", text: "אפשר לצרף כל קובץ לרעיון — PDF, מסמך, גיליון וכו׳. כפתור המהדק בתיבת התפיסה או \"קובץ\" בעורך. הקבצים מופיעים על הכרטיס ונפתחים או יורדים בלחיצה." },
];
