...
export const CHANGELOG = [
  { v: "5.72", date: "29 באוגוסט 2026", items: [
    { icon: "back", title: "החלקה חלקה יותר", text: "ביטול נקישה קטנה שהופיעה ברגע שמסך חדש נחת בהחלקה בין הלשוניות — ההחלפה בין המסכים ממתינה עכשיו שהתנועה תושלם עד הסוף." },
  ] },
