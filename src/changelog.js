...
export const CHANGELOG = [
  { v: "5.12", date: "5 ביולי 2026", items: [
    { icon: "bell", title: "דחיית תזכורת אמינה", text: "על התראת תזכורת: כפתור \"דחה 15 דק׳\" שדוחה את התזכורת ברקע בלי לפתוח את האפליקציה. לדחייה לזמן אחר — לחיצה על גוף ההתראה פותחת את הרעיון." },
  ] },
